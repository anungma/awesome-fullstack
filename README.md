...
# What to Learn
>1. [Front End](https://github.com/anungma/awesome-fullstack#front-end-tier)
2. [Middle Tier (Servers)](https://github.com/anungma/awesome-fullstack#middle-tier)
3. [Backend Tier (Database)](https://github.com/anungma/awesome-fullstack#back-end-tier-database)
4. [Dev-Ops,Product Management,Deployment, etc](https://github.com/anungma/awesome-fullstack#dev-ops-continuous-deliveryintegrationdeployment)
5. [Algorithms, AI, ML](https://github.com/anungma/awesome-fullstack#algorithms-and-data-structures)
6. [Community](https://github.com/anungma/awesome-fullstack#community)
7. [Open Sourcing: TBD](#)
9. [Interview Preparation](https://github.com/anungma/awesome-fullstack#interview-preparation)
10. [Jobs](https://github.com/anungma/awesome-fullstack#jobs)
11. [Other](https://github.com/anungma/awesome-fullstack#other)
...
>1. **HTML**
  - [Intro](https://github.com/anungma/awesome-fullstack#html-intro)
2. **CSS**
  1. [Intro](https://github.com/anungma/awesome-fullstack#css-intro)
...
3. **Javascript**
  1. [Intro](https://github.com/anungma/awesome-fullstack#js-intro)
  2. [Jquery](https://github.com/anungma/awesome-fullstack#jquery-intro)
  3. [JS Intermediate](https://github.com/anungma/awesome-fullstack#js-intermediate)
  4. [Awesome JS](https://github.com/anungma/awesome-fullstack#awesome-js-list)
4. **Client Side Development (Web)**
  - MVC-ish Frameworks
      - [React](https://github.com/anungma/awesome-fullstack#react)
        - [Redux](https://github.com/anungma/awesome-fullstack#redux)
...
5. **Design, Copy Writing, SEO, Optimization**
  - [Awesome Design, UI/UX](https://github.com/anungma/awesome-ui)
...
6. **Mobile**
  ...
  6. [React Native](https://github.com/anungma/awesome-fullstack#react-native)
7. **Gaming**
...
>1. [**Web Servers by language**](https://github.com/anungma/awesome-fullstack#server-side)
  ...
  - [Go](https://github.com/anungma/awesome-fullstack#go-server)
  - [Java](https://github.com/akullpp/awesome-java)
  - [Javascript](https://github.com/anungma/awesome-fullstack#javascript-server)
  - [PHP](https://github.com/ziadoz/awesome-php)
  - [Python](https://github.com/vinta/awesome-python)
  - [Ruby](https://github.com/anungma/awesome-fullstack#ruby)
  - [Scala](https://github.com/lauris/awesome-scala)

2. [**Networking**](https://github.com/anungma/awesome-fullstack#networking)
...
4. **Serverless**
5. [**Command Line**](https://github.com/anungma/awesome-fullstack#command-line)
6. **Hosting**
7. **Micro Services**
8. [Testing](http://stackoverflow.com/questions/520064/what-is-unit-test-integration-test-smoke-test-regression-test)
  1. [Unit Test](https://github.com/anungma/awesome-fullstack#unit-testing)
  2. [Integration Test / Functional Test](https://github.com/anungma/awesome-fullstack#integration-testing)
  3. [Smoke Test (Sanity check)](https://github.com/anungma/awesome-fullstack#smoke-testing)
  4. [Regression Test](https://github.com/anungma/awesome-fullstack#regression-testing)
  5. [Acceptance Test](https://github.com/anungma/awesome-fullstack#acceptance-testing)
  6. [Systems Test](https://github.com/anungma/awesome-fullstack#systems-testing)
  7. [Flagging Test](https://github.com/anungma/awesome-fullstack#flagging-test)
  8. [End to End Test](https://github.com/anungma/awesome-fullstack#end-to-end-testing)
...
10. [**Dev Ops / Environment/ Continous Integration**](https://github.com/anungma/awesome-fullstack#dev-ops-continuous-deliveryintegrationdeployment)
11. **Tools**
...
13. [**Platforms**](https://github.com/anungma/awesome-fullstack#platforms)
  - PAAS
    - [AWS](https://github.com/anungma/awesome-fullstack#aws)
...
>1. [**Sql**](https://github.com/anungma/awesome-fullstack#sql)
2. [**NoSql**](https://github.com/anungma/awesome-fullstack#nosql)
...
- [Dev Ops](https://github.com/anungma/awesome-fullstack#dev-ops)
